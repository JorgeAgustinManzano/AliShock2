            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" data-toggle="modal" data-target="#modalVideos" href="#">Videos</a>
                            <a class="dropdown-item" data-toggle="modal" data-target="#modalImagenes" href="#">Fotos</a>
            ...
            <div class="row">
                ...
                <div class="col-sm-7" id="app-modal1">
                    <p class="text-justify nosotros">
                        ...
                        relaciones de impacto conlosclientes.<br><br>
