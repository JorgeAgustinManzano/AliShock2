...
var imagenesGal = new Vue({
    ...
    methods: {
        abrirImagenGal(pos) {
            $("#modalGImagenes").modal('hide');//ocultamos el modal
            this.imagenA = "imagenG" + pos
            var modalG = document.getElementById("myModal");
            var imgG = document.getElementById(this.imagenA);
            var modalImg = document.getElementById("imgen01");
...
//     methods: {
//         volverModalGal() {
//             var volverGal = document.getElementById("modalGImagenes");
//             volverGal.setAttribute = data-target
//     }
// })
